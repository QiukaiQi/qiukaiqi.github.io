...
I have supervised two intern students with different topics, one on deep learning and the other on firmware development using using C language. Refer to my [CV](https://qiukaiqi.github.io/cv/) for details.